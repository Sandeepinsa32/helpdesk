...
const UpdateRecord = ({ data, onClose, readOnly }) => {
  ...
  const [isReadOnly, setIsReadOnly] = useState((createdAt) => {
    return !isDisable || localStorage.getItem("role") === "admin"
      ? true
      : false;
  });
