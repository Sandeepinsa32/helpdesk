...
>>>>>>> 8cf7ff2e543e5cc4f72778d60ffc43e062f4b668
  ...
  return (
    <Grid container spacing={3} key={1}>
      ...
      <Grid
        ...
        xs={6}
        md={12}
        sx={{ p: `16px !important`, pt: `0px !important` }}
      >
        <FormControl
          sx={{ m: 1, p: 1 }}
          fullWidth
                ...
                >
                  <FormControlLabel
                    control={
                      <Checkbox
                        checked={(name) => {
                          var remaining = checkboxType.filter(
                            (i) =>
                              i.property?.toLowerCase() != name.toLowerCase()
                          );
                        ...
                        onChange={(e) => {
                          ...
                          const productExists = initialProductType.reduce(
                            (acc, prop) => prop.property == object.property,
                            false
                          );

                          if (productExists) {
                            var remainingValues = initialProductType.filter(
                              (y) => y.property !== object.property
                            );
                            setInitialProductType([...remainingValues]);
                          } else {
                            setInitialProductType([
                              ...initialProductType,
                              object,
                            ]);
                          }
                  ...
                  {checkboxType[name] && (
                    <TextField
                      ...
                      onChange={(e) => {
                        ...
                        const index = initialProductType.findIndex(
...
<<<<<<< HEAD
      ...
      <Grid item xs={6} md={2}>
        <Box sx={displayFlexRowStyle}>
          <Box sx={displayColStyle}>
            <TextField
              error={Boolean(
                formik.touched.elderCount && formik.errors.elderCount
              )}
              fullWidth
              disabled={isView}
            ...
            {formik.values.elderCount > 0 ? (
              <TextField
                ...
                error={Boolean(
                  formik.touched.elderPrice && formik.errors.elderPrice
                )}
                helperText={
                  formik.touched.elderPrice && formik.errors.elderPrice
                }
      ...
      <Grid item xs={6} md={6}>
        <TextField
          ...
          helperText={
            (formik.touched.pnrNo && formik.errors.pnrNo) || "optional"
          }
          onBlur={formik.handleBlur}
          onChange={formik.handleChange}
      ...
      <Grid item xs={6} md={3}>
        <FormControl fullWidth disabled={isView}>
          ...
          <Select
            ...
            label="Booking Type"
            error={Boolean(
              formik.touched.bookingType && formik.errors.bookingType
            )}
      ...
      <Grid item xs={6} md={3}>
        <TextField
          ...
          helperText={
            Boolean(formik.touched.airlineCode && formik.errors.airlineCode)
              ? formik.touched.airlineCode && formik.errors.airlineCode
              : `Use Abbrivated Form`
          }
          onBlur={formik.handleBlur}
      ...
      <Grid item xs={6} md={2}>
        <TextField
          ...
          disabled={isView}
          error={Boolean(
            formik.touched.totalInhouseCharge &&
              formik.errors.totalInhouseCharge
          )}
          helperText={
            formik.touched.totalInhouseCharge &&
            formik.errors.totalInhouseCharge
