						...
						<td align='left' class='wrapper-header-logo'>
							<a target="_blank" " href=' https://triphelpdesk.com/' target='_blank' style='text-decoration:none;'>
								<img
									alt='Logo'
									class='header-logo'
									src='https://i.ibb.co/0t2DwRt/Logo.png'
									width='270'
									border='0'
									style='width:100%;max-width:270px;height:auto;-ms-interpolation-mode:bicubic;border-width:0;line-height:100%;outline-style:none;text-decoration:none;'
								/>
							</a>
						</td>
...
export const TermNCondition = `<tr>
                           <td align="center" valign="top">
			<table width="100%" align="center" cellpadding="0" cellspacing="0" border="0">
				<tbody><tr>
					<td align="center" style="padding-top:10px">
