...
const RenderSelectedEmail = ({data, values, setLoader}) => {
	...
	function newBookingFiledValues() {
		...
		newBookingFieldList.forEach((x) => {
		  ...
		  <td style="padding: 4px; text-align: left; border: 1px solid rgba(0, 0, 0, 0.2);">${x.dob}</td>
	...
	var newBooking = `<link rel="preconnect" href="https://fonts.googleapis.com">
...
<!-- ./ header  -->
<tr><td><table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" class="responsive-table" style="max-width:600px;-webkit-text-size-adjust:100%;-ms-text-size-adjust:100%;mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse !important;">
                <tbody><tr>
     ...
     <a href="https://triphelpdesk.netlify.app/" target="_blank" style="text-decoration:none;">
                ...
                <td align="right" valign="top" class="wrapper-header-address" style="font-family: 'Roboto', sans-serif;
    color: #0B4173;">     
...
<br/>
  ...
  </table><hr style="margin:2px;height: 2px;background: #051A2E;border-radius: 10px;"/></td></tr>
...
<table class="tableoutter-fields-Data-Table" style="border-collapse: collapse;margin: 0;padding: 0;width: 100%;table-layout: fixed;">
  ...
  <tbody id="appendCHildHere" style="font-size: 10px; line-height: 16px; letter-spacing: 0.05em; text-transform: uppercase; position: sticky; top: 0; z-index: 1; background: #f5f5f5; ">
    ...
    <tr style="background-color: #f8f8f8;padding: 0.35em;text-align:center;border: 1px solid #fff !important;">
		  <td style=" padding: 18px 24px;font-size:14px;color:#0B4173;font-weight:400;" class="tableHeading" scope="col" name="firstname">john</td>
		  <td style="padding: 18px 24px; font-size:14px;color:#0B4173;font-weight:400;" class="tableHeading" scope="col" name="firstname">D</td>
		  <td style=" padding: 18px 24px;font-size:14px;color:#0B4173;font-weight:400;" class="tableHeading" scope="col" name="firstname">doe</td>
		  <td style="padding: 18px 24px; font-size:14px;color:#0B4173;font-weight:400;" class="tableHeading" scope="col" name="firstname">2.72136E+11</td>
		  <td style="padding: 18px 24px;font-size:14px;color:#0B4173;font-weight:400;" class="tableHeading" scope="col" name="firstname">KFQHMW</td>
		  <td style="padding: 18px 24px; font-size:14px;color:#0B4173;font-weight:400;" class="tableHeading" scope="col" name="firstname">200</td>
		</tr>
...
<!--         <div class='table-wrapper' style="max-height: 320px;border: 1px solid #c9d1dc;overflow: auto;width: fit-content;max-width: 600px;">
	<table class='sticky-header' style='border-spacing: 0;'>
		...
		<tbody style='font-size: 14px;'>
			<tr>
				...
				<td style='padding: 18px 24px; white-space: nowrap; border-bottom: 1px solid #c9d1dc; border: none;'>Wed, 26 Oct </td>
				<td style='padding: 18px 24px; white-space: nowrap; border-bottom: 1px solid #c9d1dc; border: none;'>Air New Zealand</td>
				<td style='padding: 18px 24px; white-space: nowrap; border-bottom: 1px solid #c9d1dc; border: none;'>456 H</td>
				<td style='padding: 18px 24px; white-space: nowrap; border-bottom: 1px solid #c9d1dc; border: none;'>Air New Zealand</td>
				<td style='padding: 18px 24px; white-space: nowrap; border-bottom: 1px solid #c9d1dc; border: none;'>7:45 pm</td>
				<td style='padding: 18px 24px; white-space: nowrap; border-bottom: 1px solid #c9d1dc; border: none;'>Wellington Intl Airport (WLG)</td>
				<td style='padding: 18px 24px; white-space: nowrap; border-bottom: 1px solid #c9d1dc; border: none;'>8:50 pm</td>
				<td style='padding: 18px 24px; white-space: nowrap; border-bottom: 1px solid #c9d1dc; border: none;'>Auckland Airport (AKL)</td>
       ...
       <tr>
         <td class="header-para-12x" style=" padding: .625em;font-size:14px;color:#0B4173;font-weight:400;" scope="row">
         <b>Tue, 26 Apr</b> - Alaska Airlines 2057 - Operated By Subsidiary- 1h 40m
         </td>
        </tr>
        <tr>
           <td class="header-para-12x" style=" padding: .625em;font-size:14px;color:#0B4173;font-weight:400;" scope="row">
...
<tr><td>
  	<table width="100%" align="center" cellpadding="0" cellspacing="0" border="0">
				<tbody><tr>
					...
					<table width="100%" align="center" cellpadding="0" cellspacing="0" border="0">
						<tbody><tr>
							<td bgcolor="#efefef" align="center" style="border-radius:10px;padding:15px;border:2px solid #efefef ;
  ...
  background-repeat: no-repeat;">
							<table width="100%" align="center" cellpadding="0" cellspacing="0" border="0">
								<tbody><tr>
									<td align="left" style="font-family: 'Roboto', sans-serif;font-size:14px;line-height:22px;color:#000000">
<!-- 									<p style="padding:0;margin:0px 0px 16px;font-size:18px;line-height:12px;font-weight:700">Additional Information</p> -->
             <div>
...
<div class="Wrapper-holder" style="overflow: hidden; width: 100%; text-align: justify; text-rendering: optimizespeed; text-transform: capitalize; margin: 0;">
  ...
  <div class="Term-condtion-Div" style="height: 400px; max-height: 100%; overflow-y: auto !important;"> 
    ...
    <p class="para-font" style="font-family: 'Roboto', sans-serif; ;font-size: 12px; text-rendering: optimizespeed; text-transform: capitalize; line-height: 20px; font-weight: 600; text-align: center !important;">Section1 - General Provisions 
</p>
...
<!--    section 2   -->
      ...
      <p class="para-font" style="font-family: 'Roboto', sans-serif; ;font-size: 12px; text-rendering: optimizespeed; text-transform: capitalize; line-height: 20px; font-weight: 600; text-align: center !important;">Section 2 - Access and Use of our Services 
</p>
...
Portion or feature of our Services at any time in our sole discretion and without prior notice. Your searching may also be throttled; to avoid traffic congestions and if we deem your behavior abusive to our internal systems or your use of our platform is being misappropriated for enterprise purposes.  Any action by you that, in our sole discretion: (i) violates the terms and conditions of this Agreement and/or the Privacy Policy; (ii) restricts, inhibits or prevents any access, use or enjoyment of our Services; or (iii) through the use of our Services, defames, abuses, harasses, offends or threatens, shall not be permitted, and may result in your loss of the right to access and use our Services. You shall not modify, scrape, embed, frame or otherwise display our Services without our prior written permission. 
    ...
    <!--    section 3   -->
      ...
      <p class="para-font" style="font-family: 'Roboto', sans-serif; ;font-size: 12px; text-rendering: optimizespeed; text-transform: capitalize; line-height: 20px; font-weight: 600; text-align: center !important;">Section 3 - Electronic Communications 
    ...
    <!--    section 4   -->
      ...
      <p class="para-font" style="font-family: 'Roboto', sans-serif; ;font-size: 12px; text-rendering: optimizespeed; text-transform: capitalize; line-height: 20px; font-weight: 600; text-align: center !important;">Section 5 - Ticketing and Exchange Fees  
</p>
...
<b>6.5 Credit Card Chargebacks</b>
    <p class="para-font" style="font-family: 'Roboto', sans-serif; ;font-size: 12px; text-align: justify; text-rendering: optimizespeed; text-transform: capitalize; line-height: 20px; margin: 0 20px;">
...
<!-- section 7  --> 
  ...
  <p class="para-font" style="font-family: 'Roboto', sans-serif; ;font-size: 12px; text-rendering: optimizespeed; text-transform: capitalize; line-height: 20px; font-weight: 600; text-align: center !important;">Section 7 - Foreign Currency 
...
<!-- section 8  --> 
  ...
  <p class="para-font" style="font-family: 'Roboto', sans-serif; ;font-size: 12px; text-rendering: optimizespeed; text-transform: capitalize; line-height: 20px; font-weight: 600; text-align: center !important;">Section 8 - Correction of Errors 
</p>
...
<!-- section 9 --> 
  ...
  <p class="para-font" style="font-family: 'Roboto', sans-serif; ;font-size: 12px; text-rendering: optimizespeed; text-transform: capitalize; line-height: 20px; font-weight: 600; text-align: center !important;">Section 9 - Schedule Changes and Flight Delays
...
<!-- section 10 --> 
  <p class="para-font" style="font-family: 'Roboto', sans-serif; ;font-size: 12px; text-rendering: optimizespeed; text-transform: capitalize; line-height: 20px; font-weight: 600; text-align: center !important;">Section 10 - Your Responsibilities 
</p>
...
<!-- section 11 --> 
  <p class="para-font" style="font-family: 'Roboto', sans-serif; ;font-size: 12px; text-rendering: optimizespeed; text-transform: capitalize; line-height: 20px; font-weight: 600; text-align: center !important;">Section 11 - Frequent Traveler/Flyer Points and Miles 
...
<!--  ./footer   -->
<tr><td> <hr style="margin:2px;height: 2px;background: #051A2E;border-radius: 10px;"/>
