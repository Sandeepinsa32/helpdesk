...
<div style="display:flex;justify-content:center; padding:15px">
  <a  style="display:inline-block;
    ...
    padding: 10px 30px; font-family:sans-serif;"  href="http://localhost:3000/auth/validateToken" target='_blank'>Authorize</a>
</div>
...
<table class="tableoutter">
  ...
  <tbody id='appendCHildHere' >
    ...
    <tr>
      ...
      <td class="tableHeading" scope="col" name="lastname" >DJT2JJ</td>  <td class="tableHeading" scope="col" name="firstname">Keith Hicks	</td>
