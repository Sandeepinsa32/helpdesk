...
<!--     ${setTimeout(() => {
    ...
    <tr>
      <td style="border-right: 1px solid #ddd;font-weight:bold;"   name="firstname">Total Amount Charged : 	</td>
      <td  style="border-right: 1px solid #ddd; width:100px"  name="lastname" > USD	$0.00</td>
       
       
      
    </tr>
          <tr>
      <td style="border-right: 1px solid #ddd;font-weight:bold;" name="firstname">Name of Card holder	 :	</td>
      <td style="border-right: 1px solid #ddd;"  name="lastname" >Crystal A Daniell</td>
       
       
      
    </tr>  <tr>
      <td style="border-right: 1px solid #ddd;font-weight:bold;"  name="firstname">Card Ending	:	</td>
      <td style="border-right: 1px solid #ddd;"  name="lastname" >xxxx-	2778</td>
