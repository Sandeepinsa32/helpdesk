...
const Email = ({ Ticketid, onClose }) => {
  ...
  function renderFields() {
    switch (selectedEmailTemplate) {
      case 1:
        return (
          <NewBooking inputList1={inputList1} setInputList1={setInputList1} />
        );
      case 2:
        return (
          <Exchange inputList2={inputList2} setInputList2={setInputList2} />
        );
      case 3:
        return <Refund inputList3={inputList3} setInputList3={setInputList3} />;
      case 4:
        return (
          <FutureCredit inputList4={inputList4} setInputList4={setInputList4} />
        );
