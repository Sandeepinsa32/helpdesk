...
const Email = ({ Ticketid, userData, onClose }) => {
      ...
      .post(
        ...
        },
        {
          headers: {
            ...
            PUBLIC_APP_KEY:
              "c73d43e41af0b1489a5d4f011937a1b63060f2babd0e78ad8d3b952d3847c350",
  ...
  const formik = useFormik({
    ...
    validationSchema: Yup.object({
      ...
      ccLastDigit: Yup.string("input must consist if number")
          ...
          <Grid container spacing={1} sx={{ m: 0, p: 1 }}>
            ...
            <Grid item md={3} sx={{ mt: 2 }}>
              <Textfield
                ...
                error={Boolean(
                  formik.touched.cLastDigit && formik.errors.cLastDigit
                )}
                helperText={
                  formik.touched.cLastDigit && formik.errors.cLastDigit
                }
