...
export const Transaction = () => {
  ...
  const [authorizeDetailModelOpen, setAuthorizeDetailModelOpen] =
    useState(false);
  ...
  return (
    <>
                    ...
                    myRecords.map((row, index) => (
                      ...
                      >
                        ...
                        <TableCell sx={{ p: 0 }}>
                          ...
                          <Tooltip
                            title={
                              CheckViewUpdate(row.createdAt) ? "Edit" : "View"
                            }
                          >
                            <IconButton
                              aria-label="update"
      ...
      >
        <Box sx={BoxModalStyle} style={{ paddingTop: 0 }}>
          <Card sx={{ p: 0, m: 0 }}>
            ...
            <CardContent
              sx={{ minHeight: "80vh", maxHeight: "85vh", overflowX: " auto" }}
            >
      ...
      <Modal
        ...
        aria-describedby="modal-modal-description"
      >
        <Box sx={BoxModalStyle} style={{ overflow: "hidden", padding: 4 }}>
          <Card sx={{ p: 0, m: 0 }}>
            <CardHeader
              // sx={{py: '0 !important'}}
      ...
      {/* Open Charge Modal */}
      <Modal
        open={chargeModelOpen}
        onClose={() => setChargeModelOpen(false)}
        size="xs"
        aria-labelledby="modal-modal-title"
        aria-describedby="modal-modal-description"
      >
        <Box sx={BoxModalStyle}>
          <IconButton
            onClick={() => setChargeModelOpen(false)}
            sx={{ position: `absolute`, right: `10px`, top: `10px` }}
          >
            <CloseIcon />
          </IconButton>
      ...
      {/* Open airline Modal */}
      <Modal
        open={airlineModelOpen}
        onClose={() => setAirlineModelOpen(false)}
        size="xs"
        aria-labelledby="modal-modal-title"
        aria-describedby="modal-modal-description"
      >
        <Box sx={BoxModalStyle}>
          <IconButton
            onClick={() => setAirlineModelOpen(false)}
            sx={{ position: `absolute`, right: `10px`, top: `10px` }}
          >
            <CloseIcon />
          </IconButton>
      ...
      <Modal
        open={authorizeDetailModelOpen}
        onClose={() => setAuthorizeDetailModelOpen(false)}
        size="xs"
        aria-labelledby="modal-modal-title"
        aria-describedby="modal-modal-description"
      >
